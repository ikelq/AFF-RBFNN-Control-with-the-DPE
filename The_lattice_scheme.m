...
figure
plot(t,e')
plot_line(t,e','t [s]',label_y,[-13,0.4])
plot_line(t,de','t [s]',label_y,legend_y,[-13,0.4])
...
last_100_seconds_e_q=e(:,length(t)-10000:length(t));
