...
plot_2line(t(t2),[Tau_cl(t2)',Tau_rl(t2)',Tau_cl(t2)'],[error_RBF_cl0(t2)',error_RBF_rl0(t2)',error_RBF_O0(t2)'],'t [s]',label_y,...
    legend_y1,legend_y2,[-9,-0.1;-9,0.01]);
print('D:\GE\robot control\06-Adaptive Feedforward RBF Neural-Network Learning Control\LaTeX_DL_468198_240419\latex_dl\Tracking_performance_12',...
 '-depsc',  '-painters','-r600')
...
label_y=["Evolving Weights";"Approximation Error"];
legend_y1=[""];
legend_y2=[""];
plot_2line(t,weight_O',error_RBF_O0','t [s]',label_y,legend_y1,legend_y2,[-100,0;-100,5]);
...
legend_y1=[""];
legend_y2=[""];
plot_2line(t,weight_rl',error_RBF_rl0','t [s]',label_y,legend_y1,legend_y2,[-100,0;-100,5]);
...
legend_y1=[""];
legend_y2=[""];
plot_2line(t,weight_cl',error_RBF_cl0,'t [s]',label_y,legend_y1,legend_y2,[-100,0;-100,5]);
